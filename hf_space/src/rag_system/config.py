...
class LLMConfig(BaseModel):
    ...
    # Groq dev tier enforces ~8k tokens per request; keep retrieved context smaller.
    max_context_tokens: int = Field(4200, ge=512, le=120_000)
    max_chars_per_chunk: int = Field(900, ge=200, le=20_000)
    model_config = {"frozen": True}
